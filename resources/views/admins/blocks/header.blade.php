                ...
                <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                            ...
                            <div class="noti-scroll" data-simplebar>
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/admin/assets/images/users/user-12.jpg') }}"
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/admin/assets/images/users/user-2.jpg') }}"
                                            class="img-fluid rounded-circle" alt="" />
                                    </div>
                                ...
                                <a href="javascript:void(0);"
                                    class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/admin/assets/images/users/user-3.jpg') }}"
                                            class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="notify-content">
                                        <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);"
                                    class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/admin/assets/images/users/user-8.jpg') }}"
                                            class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0);"
                                    class="dropdown-item notify-item text-muted link-primary">
                                    <div class="notify-icon">
                                        <img src="{{ asset('assets/admin/assets/images/users/user-5.jpg') }}"
                                            class="img-fluid rounded-circle" alt="" />
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown"
                            ...
                            <img src="{{ asset('assets/admin/assets/images/users/user-11.jpg') }}"
