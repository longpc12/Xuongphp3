                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admins.products.update', $editProduct->id) }}" method="POST"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="slug" name="slug" is-invalid
                                                ...
                                                value="{{ $editProduct->slug }}" placeholder="mã sản phẩm">
                                            @error('slug')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="name_product" name="name_product" is-invalid
                                                ...
                                                value="{{ $editProduct->name_product }}" placeholder="Tên sản phẩm">
                                            @error('name_product')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="price_regular" name="price_regular" is-invalid
                                                ...
                                                value="{{ $editProduct->price_regular }}" placeholder="giá sản phẩm">
                                            @error('price_regular')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="price_sale" name="price_sale" is-invalid
                                                ...
                                                value="{{ $editProduct->price_sale }}" placeholder="giá giảm">
                                            @error('price_sale')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="category_id" id=""
                                                ...
                                                {{-- cách 2 --}}
                                                {{-- 
                                                    <option value="{{ $editProduct->category->id }}"
                                                        {{ $editProduct->category->id ? 'selected' : '' }}>
                                                        {{ $editProduct->category->name_category }}
                                                    </option> --}}
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="quantity" name="quantity" is-invalid
                                                ...
                                                value="{{ $editProduct->quantity }}" placeholder="số lượng">
                                            @error('quantity')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="input_day" name="input_day" is-invalid
                                                ...
                                                value="{{ $editProduct->input_day }}" placeholder="ngày nhập">
                                            @error('input_day')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="description" rows="3" class="form-control"
                                                placeholder="Mô tả ngắn">{{ $editProduct->description }}</textarea>
                                            @error('description')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="img_category"
                                                src="{{ Storage::url($editProduct->thumbnail_url) }}"
                                        ...
                                        <div class=" form-switch ps-3 mb-2 d-flex justify-content-between">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input bg-primary" type="checkbox"
                                                    role="switch" id="is_new" name="is_new"  {{$editProduct->is_new == 1 ? 'checked' : ''}}>
                                                <label class="form-check-label " for="is_new">IS NEW</label>
                                            </div>

                                            <div class="form-check">
                                                <input class="form-check-input bg-danger" type="checkbox"
                                                    role="switch" id="is_hot" name="is_hot"  {{$editProduct->is_hot == 1 ? 'checked' : ''}}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input bg-warning" type="checkbox"
                                                    role="switch" id="is_hot_deal" name="is_hot_deal"  {{$editProduct->is_hot_deal == 1 ? 'checked' : ''}}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input bg-success" type="checkbox"
                                                    role="switch" id="is_show_home" name="is_show_home"  {{$editProduct->is_show_home == 1 ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-10 d-flex gap-2 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="	is_type"
                                                    id="gridRadios1" value="1" {{$editProduct->is_type == 1 ? 'checked' : ''}} >
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="	is_type"
                                                    id="gridRadios2" value="0" {{$editProduct->is_type == 0 ? 'checked' : ''}}>
                                            ...
                                            <label for="imgae" class="form-label">Album hình ảnh
                                                ...
                                                <table class="table align-middle table-nowrap mb-0">
                                                    <tbody class="image-table-body">
                                                        @foreach ($editProduct->ProductImage as $index => $image)
                                                        <tr>
                                                            <td class="d-flex align-items-center">
                                                                ...
                                                                <input type="file" id="image"
                                                                    name="list_image[{{$image->id}}]" is-invalid
                                                                    class="form-control"
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var old_contnent = `{!! $editProduct->content !!}`;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var rowCount = {{count($editProduct->ProductImage)}};
