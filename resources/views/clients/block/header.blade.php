                ...
                <div class="container">
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-2">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{asset('assets/client/assets/img/logo/HL.jpg')}}" style="width:100px" alt="Brand Logo">
                                </a>
                            </div>
                        </div>
                        <!-- start logo area -->
                                        ...
                                        <ul>
                                                ...
                                                <ul class="megamenu dropdown">
                                                    ...
                                                    <li class="megamenu-banners d-none d-lg-block">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/banner/img1-static-menu.jpg')}}" alt="">
                                                        </a>
                                                    </li>
                                                    <li class="megamenu-banners d-none d-lg-block">
                                                        <a href="product-details.html">
                                                            <img src="{{asset('assets/client/assets/img/banner/img2-static-menu.jpg')}}" alt="">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="shop.html">shop <i class="fa fa-angle-down"></i></a>
                                                <ul class="dropdown">
                                                    ...
                                                    <li><a href="{{ route('user.shop.category', $category->id) }}">{{ $category->name_category }}</a></li>
                                                @endforeach --}}
                                                </ul>
                                            </li>
                            ...
                            <div class="header-right d-flex align-items-center justify-content-xl-between justify-content-lg-end">
                                ...
                                <div class="header-configure-area">
                                    <ul class="nav justify-content-end">
                                        <li class="user-hover">
                                            ...
                                            <ul class="dropdown-list">
                                                ...
                                                @else
                                                    ...
                                                    <li><a href="{{route('user.oders.index')}}">My order</a></li>
                                                    <li>
                                                        <a href="{{ route('logout') }}"
                                        ...
                                        <li>
                                            <a href="{{route('user.product.cart')}}" class="minicart-btn">
